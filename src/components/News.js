...
export class New extends Component {
    ...
    async componentDidMount(){
        console.log("cdm");
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=7590a6c617f341e4b468b099a27121f1&page=1&pageSize=20";
    ...
    handlePreviousClick = async () =>{
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=7590a6c617f341e4b468b099a27121f1&page=${this.state.page-1}&pageSize=20`;
        let data = await fetch(url);
        let parsedData = await data.json();
        console.log(parsedData);
        this.setState({
