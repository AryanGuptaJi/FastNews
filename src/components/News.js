...
export class New extends Component {
    ...
    async componentDidMount(){
        console.log("cdm");
        let url = `https://newsapi.org/v2/everything?q=tesla&from=2022-12-26&sortBy=publishedAt&apiKey=7590a6c617f341e4b468b099a27121f1&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePreviousClick = async () =>{
        ...
        let url = `https://newsapi.org/v2/everything?q=tesla&from=2022-12-26&sortBy=publishedAt&apiKey=7590a6c617f341e4b468b099a27121f1&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
        this.setState({loading: true});
        let data = await fetch(url);
        let parsedData = await data.json();
        console.log(parsedData);
